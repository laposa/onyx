...
psql $temp_database_name < $onyxectory/project_skeleton/$template_filename
psql $temp_database_name < $onyxectory/docs/database/$upgrade_filename
pg_dump --no-owner $temp_database_name  > $onyxectory/project_skeleton/$template_filename
