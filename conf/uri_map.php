...
$uri_map = array(
    ...
    '^/component-library/?$' => '/index.php?request=' . ONYX_SITE_TEMPLATE . '.' . 'component/library',
    ...
    '^/backoffice' => array(
        ...
        '^/backoffice/node/([0-9]*)$' => '/index.php?request=bo/backoffice_wrapper.bo/backoffice~id=$1~.bo/pages/pages~id=$1~',
        ...
        '^/backoffice/news/edit/([a-z]*)/([0-9]*)$' => '/index.php?request=bo/backoffice_wrapper.bo/pages/news_edit~id=$2~.bo/component/node_edit~id=$2~',
        '^/backoffice/comments$' => '/index.php?request=bo/backoffice_wrapper.bo/backoffice.bo/pages/comments',
        '^/backoffice/comments/products$' => '/index.php?request=bo/backoffice_wrapper.bo/backoffice.bo/pages/comments&products=1',
        '^/backoffice/comments/recipes$' => '/index.php?request=bo/backoffice_wrapper.bo/backoffice.bo/pages/comments&recipes=1',
        '^/backoffice/surveys$' => '/index.php?request=bo/backoffice_wrapper.bo/backoffice.bo/pages/surveys',
        '^/backoffice/surveys/([0-9]*)/detail$' => '/index.php?request=bo/backoffice_wrapper.bo/backoffice.bo/component/survey_detail&id=$1',
        ...
        '^/backoffice/advanced/media$' => '/index.php?request=bo/backoffice_wrapper.bo/backoffice.bo/pages/advanced.bo/pages/server_browser',
        '^/backoffice/advanced/taxonomy$' => '/index.php?request=bo/backoffice_wrapper.bo/backoffice.bo/pages/advanced.bo/pages/taxonomy.bo/component/taxonomy_edit',
        ...
        '^/backoffice/stats$' => '/index.php?request=bo/backoffice_wrapper.bo/backoffice.bo/pages/statistic',
        '^/backoffice/advanced$' => '/index.php?request=bo/backoffice_wrapper.bo/backoffice.bo/pages/advanced.bo/component/advanced_intro',
        '^/backoffice/advanced/configuration$' => '/index.php?request=bo/backoffice_wrapper.bo/backoffice.bo/pages/advanced.bo/pages/configuration',
        '^/backoffice/advanced/currency$' => '/index.php?request=bo/backoffice_wrapper.bo/backoffice.bo/pages/advanced.bo/pages/currency',
        '^/backoffice/advanced/logs$' => '/index.php?request=bo/backoffice_wrapper.bo/backoffice.bo/pages/advanced.bo/pages/logs',
        '^/backoffice/advanced/templates$' => '/index.php?request=bo/backoffice_wrapper.bo/backoffice.bo/pages/advanced.bo/pages/templates',
        '^/backoffice/advanced/database$' => '/index.php?request=bo/backoffice_wrapper.bo/backoffice.bo/pages/advanced.bo/pages/database',
        ...
        '^/backoffice/products$' => '/index.php?request=bo/backoffice_wrapper.bo/backoffice.bo/pages/ecommerce/products.bo/component/ecommerce/product_list',
        '^/backoffice/products/product_add$' => '/index.php?request=bo/backoffice_wrapper.bo/backoffice.bo/component/ecommerce/product_add_quick',
        '^/backoffice/products/offer_add$' => '/index.php?request=bo/backoffice_wrapper.bo/backoffice.bo/component/ecommerce/offer_add',
        '^/backoffice/products/offer_group_add$' => '/index.php?request=bo/backoffice_wrapper.bo/backoffice.bo/component/ecommerce/offer_group_edit',
        '^/backoffice/products/offer_group/([0-9]*)/edit$' => '/index.php?request=bo/backoffice_wrapper.bo/backoffice.bo/component/ecommerce/offer_group_edit&offer_group_id=$1',
        ...
        '^/backoffice/stores$' => '/index.php?request=bo/backoffice_wrapper.bo/backoffice.bo/pages/ecommerce/stores.bo/component/ecommerce/store_list',
        '^/backoffice/stores/store_add$' => '/index.php?request=bo/backoffice_wrapper.bo/backoffice.bo/component/ecommerce/store_add',
    ...
    '^/print' => array(
        '^/print/invoice/(.*)$' => '/index.php?request=node/site/print.component/ecommerce/invoice&id=$1',
        '^/print/invoice_proforma/(.*)$' => '/index.php?request=node/site/print.component/ecommerce/invoice@component/ecommerce/invoice_proforma&id=$1',
        '^/print/gift_card/(.*)$' => '/index.php?request=node/site/print.component/ecommerce/gift_card&order_id=$1'
    )
