 ...
 *
 * Copyright (c) 2010-2012 Laposa Limited (https://laposa.ie)
...
define('ECOMMERCE_TRANSACTION_PAYPAL_VENDOR_EMAIL', $GLOBALS['onyx_conf']['global']['admin_email']);
define('ECOMMERCE_TRANSACTION_PAYPAL_DESCRIPTION', "Payment for order at {$GLOBALS['onyx_conf']['global']['title']}.");
