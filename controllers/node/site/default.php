...
class Onxshop_Controller_Node_Site_Default extends Onxshop_Controller {
    ...
    public function mainAction() {
        ...
        $_Onxshop_Request = new Onxshop_Request("component/menu~id=" . $node_conf['id_map-global_navigation'] . ":level=1:open={$this->GET['id']}:node_group=page~");
        ...
        if ($GLOBALS['onxshop_conf']['global']['display_secondary_navigation'] == 1) {
            $_Onxshop_Request = new Onxshop_Request("component/menu~level=1:expand_all=0:display_teaser=0:id=" . $node_conf['id_map-primary_navigation'] . ":open={$this->GET['id']}:node_group=page~");
        } else {
            $_Onxshop_Request = new Onxshop_Request("component/menu~level=3:expand_all=0:display_teaser=0:id=" . $node_conf['id_map-primary_navigation'] . ":open={$this->GET['id']}:node_group=page~");
        }
        ...
        $_Onxshop_Request = new Onxshop_Request("component/menu~id=" . $node_conf['id_map-footer_navigation'] . ":level=1:open={$this->GET['id']}:node_group=page~");
