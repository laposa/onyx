...
class Onxshop_Controller_Component_Ecommerce_Product_List_5columns extends Onxshop_Controller_Component_Ecommerce_Product_List {
    ...
    function processItems($product_list, $image_width, $from, $per_page, $divide_after = 5) {
