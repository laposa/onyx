<?php
	...
	function doDefault() {
		...
		echo "<p><label for=\"paginate\"><input type=\"checkbox\" id=\"paginate\" name=\"paginate\"", (isset($_REQUEST['paginate']) ? ' checked="checked"' : ''), " />&nbsp;{$lang['strpaginate']}</label> <span style='color: red'>Make sure this option is switch off for UPDATE queries</span></p>\n";
