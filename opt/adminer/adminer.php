...
//BEGIN ONYX
/**
 * detect onyx project directory
 */
$onyx_project_dir =  preg_replace('/public_html\/opt\/adminer/', '', dirname($_SERVER['SCRIPT_FILENAME']));
/**
 * include Onyx project configuration
 */
require_once($onyx_project_dir . 'conf/global.php');
/**
